...
double U1s = 1.5;               // superficial velocity of phase 1 (heavier phase)                
double U2s = 2.0;               // superficial velocity of phase 2 (lighter phase)
double h_L_D = 0.2;             // Liquid holdup  
double diameter = 1.0;          // pipe diameter 
double pipe_length = 1.5;       // pipe length 
...
int main(){
    ...
    init_grid (64);               // grid number without refinement 
